...
std::string WKTWriter::writeMultiLineString(const geom::GeoMultiLineString *mls)
{
...
std::string WKTWriter::writeCoordinateSequence(const geom::GeoCoordinateSequence *cseq)
{
    std::string wkt = "(";
